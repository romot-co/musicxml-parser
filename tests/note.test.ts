...
describe('Note Schema Tests (note.mod)', () => {
  describe('mapNoteElement', () => {
    it('should parse a basic <note> with <pitch>, <duration>, <type>, and <stem>', () => {
      const xml = '<note><pitch><step>C</step><octave>4</octave></pitch><duration>2</duration><type>eighth</type><stem>up</stem></note>';
    ...
    it('should parse a <note> with <rest>', () => {
      const xml = '<note><rest/><duration>4</duration><type>quarter</type></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <chord>', () => {
      const xml = '<note><chord/><pitch><step>E</step><octave>4</octave></pitch><duration>2</duration></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <lyric>', () => {
      const xml = '<note><pitch><step>G</step><octave>4</octave></pitch><duration>4</duration><lyric><syllabic>single</syllabic><text>Hel</text></lyric><lyric><syllabic>begin</syllabic><text>lo</text></lyric></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <notations> and <slur>', () => {
      const xml = '<note><pitch><step>D</step><octave>5</octave></pitch><duration>2</duration><notations><slur type="start" number="1" placement="above"/></notations></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <accidental>', () => {
      const xml = '<note><pitch><step>F</step><alter>1</alter><octave>4</octave></pitch><duration>4</duration><accidental>sharp</accidental></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <dot>', () => {
      const xml = '<note><pitch><step>G</step><octave>4</octave></pitch><duration>3</duration><type>eighth</type><dot/></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <grace slash="yes">', () => {
      const xml = '<note><grace slash="yes"/><pitch><step>A</step><octave>4</octave></pitch><type>eighth</type></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse a <note> with <unpitched>', () => {
      const xml = '<note><unpitched><display-step>E</display-step><display-octave>4</display-octave></unpitched><duration>2</duration><type>eighth</type></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
    ...
    it('should parse print-leger attribute on note', () => {
      const xml = '<note print-leger="no"><pitch><step>C</step><octave>6</octave></pitch><duration>1</duration></note>';
      const element = createElement(xml);
      const note = mapNoteElement(element);
