...
export const KindValueEnum = z.enum([
  ...
  'diminished-seventh', 'augmented-seventh', 'half-diminished', 'major-minor', 'major-sixth',
  'minor-sixth', 'dominant-ninth', 'major-ninth', 'minor-ninth', 'dominant-11th', 'major-11th',
  'minor-11th', 'dominant-13th', 'major-13th', 'minor-13th', 'suspended-second', 'suspended-fourth',
  'power', 'none', 'other' // 'other' requires text attribute
]);
